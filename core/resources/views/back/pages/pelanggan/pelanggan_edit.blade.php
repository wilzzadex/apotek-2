                        ...
                        <form method="POST" action="{{ route('pelanggan.update',$pelanggan->id) }}" id="userAdd">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama" value="{{ $pelanggan->nama_instansi }}" placeholder="Nama Suplier" />
                                </div>
                                <div class="form-group">
                                    <label>Alamat
                                    <span class="text-danger">*</span></label>
                                   <textarea name="alamat" class="form-control" cols="30" rows="5">{{ $pelanggan->alamat }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Penanggung Jawab
                                    <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="p_jawab" value="{{ $pelanggan->penanggung_jawab }}" placeholder="Penanggung Jawab" />
                                </div>
                                <div class="form-group">
                                    <label>No Telpon
                                    <span class="text-danger">*</span></label>
